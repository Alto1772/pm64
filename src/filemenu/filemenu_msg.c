...
u8 filemenu_msg_06[] = { MSG_CHAR_READ_VARIANT1, MSG_CHAR_UPPER_N, MSG_CHAR_UPPER_E, MSG_CHAR_UPPER_W, MSG_CHAR_READ_END };
...
u8 filemenu_createfile_gridData[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D,
...
s32 gFileMenuMessages[] = {
    ...
    (s32)filemenu_msg_30, (s32)filemenu_msg_31, (s32)filemenu_msg_32,
#if !VERSION_JP
    (s32)filemenu_msg_33, (s32)filemenu_msg_34,
#endif
};
#endif
...
#if VERSION_JP
        if (texSizeX >= 16 && texSizeX % 16 - 16 == 0)
#else
...
void filemenu_draw_message(u8* message, s32 x, s32 y, s32 alpha, s32 color, u32 flags) {
    ...
    if ((s32) message < 0) {
        ...
        draw_msg((s32) message, x, y, alpha, color, flags);
    }
#endif
}
