...
enum ActorTypes {
    ...
    // in JP ACTOR_TYPE_ALBINO_DINO was moved to here
    ACTOR_TYPE_ALBINO_DINO                           = 0x3B,
    ACTOR_TYPE_DUPLIGHOST                            = 0x3C,
    ACTOR_TYPE_GHOST_GOOMBARIO                       = 0x3D,
    ACTOR_TYPE_GHOST_KOOPER                          = 0x3E,
    ACTOR_TYPE_GHOST_BOMBETTE                        = 0x3F,
    ACTOR_TYPE_GHOST_PARAKARRY                       = 0x40,
    ACTOR_TYPE_GHOST_BOW                             = 0x41,
    ACTOR_TYPE_GHOST_WATT                            = 0x42,
    ACTOR_TYPE_GHOST_SUSHIE                          = 0x43,
    ACTOR_TYPE_GHOST_LAKILESTER                      = 0x44,
