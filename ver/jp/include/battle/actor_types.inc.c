// TODO: convert these back to actors.yaml
#include "common.h"
...
s32 bActorNames[] = {
    ...
    [ACTOR_TYPE_FLYING_MAGIKOOPA]           MSG_EnemyName_MagikoopaDup,
    [ACTOR_TYPE_MAGICLONE]                  MSG_EnemyName_Magiclone,
    [ACTOR_TYPE_FLYING_MAGICLONE]           MSG_EnemyName_MagicloneDup,
    [ACTOR_TYPE_RED_MAGIKOOPA]              MSG_EnemyName_RedMagikoopa,
    [ACTOR_TYPE_FLYING_RED_MAGIKOOPA]       MSG_EnemyName_FlyingRedMagikoopa,
    [ACTOR_TYPE_GREEN_MAGIKOOPA]            MSG_EnemyName_GreenMagikoopa,
    [ACTOR_TYPE_FLYING_GREEN_MAGIKOOPA]     MSG_EnemyName_FlyingGreenMagikoopa,
    [ACTOR_TYPE_YELLOW_MAGIKOOPA]           MSG_EnemyName_YellowMagikoopa,
    [ACTOR_TYPE_FLYING_YELLOW_MAGIKOOPA]    MSG_EnemyName_FlyingYellowMagikoopa,
    [ACTOR_TYPE_GRAY_MAGIKOOPA]             MSG_EnemyName_GrayMagikoopa,
    [ACTOR_TYPE_FLYING_GRAY_MAGIKOOPA]      MSG_EnemyName_FlyingGrayMagikoopa,
    [ACTOR_TYPE_WHITE_MAGIKOOPA]            MSG_EnemyName_WhiteMagikoopa,
    [ACTOR_TYPE_FLYING_WHITE_MAGIKOOPA]     MSG_EnemyName_FlyingWhiteMagikoopa,
    [ACTOR_TYPE_UNUSED_5B]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_5C]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_5D]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_5E]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_5F]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_60]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_61]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_62]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_63]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_64]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_65]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_66]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_67]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_68]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_69]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_6A]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_MONTY_HOLE]                 MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_6C]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_6D]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_PLAYER]                     MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_GOOMBARIO]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_KOOPER]                     MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_BOMBETTE]                   MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_PARAKARRY]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_BOW]                        MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_WATT]                       MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_SUSHIE]                     MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_LAKILESTER]                 MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_TWINK]                      MSG_EnemyName_Twink,
    [ACTOR_TYPE_UNUSED_78]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_UNUSED_79]                  MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_THE_MASTER_1]               MSG_EnemyName_TheMaster1,
    [ACTOR_TYPE_THE_MASTER_2]               MSG_EnemyName_TheMaster2,
    [ACTOR_TYPE_THE_MASTER_3]               MSG_EnemyName_TheMaster3,
    [ACTOR_TYPE_CHAN]                       MSG_EnemyName_Chan,
    [ACTOR_TYPE_LEE]                        MSG_EnemyName_Lee,
    [ACTOR_TYPE_LEE_GOOMBARIO]              MSG_EnemyName_LeeGoombario,
    [ACTOR_TYPE_LEE_KOOPER]                 MSG_EnemyName_LeeKooper,
    [ACTOR_TYPE_LEE_BOMBETTE]               MSG_EnemyName_LeeBombette,
    [ACTOR_TYPE_LEE_PARAKARRY]              MSG_EnemyName_LeeParakarry,
    [ACTOR_TYPE_LEE_BOW]                    MSG_EnemyName_LeeBow,
    [ACTOR_TYPE_LEE_WATT]                   MSG_EnemyName_LeeWatt,
    [ACTOR_TYPE_LEE_SUSHIE]                 MSG_EnemyName_LeeSushie,
    [ACTOR_TYPE_LEE_LAKILESTER]             MSG_EnemyName_LeeLakilester,
    [ACTOR_TYPE_KAMMY_KOOPA]                MSG_EnemyName_KammyKoopa,
    [ACTOR_TYPE_JR_TROOPA_1]                MSG_EnemyName_JrTroopaUnused,
    [ACTOR_TYPE_JR_TROOPA_2]                MSG_EnemyName_JrTroopa1,
    [ACTOR_TYPE_JR_TROOPA_3]                MSG_EnemyName_JrTroopa2,
    [ACTOR_TYPE_JR_TROOPA_4]                MSG_EnemyName_JrTroopa3,
    [ACTOR_TYPE_JR_TROOPA_5]                MSG_EnemyName_JrTroopa4,
    [ACTOR_TYPE_JR_TROOPA_6]                MSG_EnemyName_JrTroopa5,
    [ACTOR_TYPE_JR_TROOPA_DUP1]             MSG_EnemyName_JrTroopa5,
    [ACTOR_TYPE_JR_TROOPA_DUP2]             MSG_EnemyName_JrTroopa5,
    ...
    [ACTOR_TYPE_GOOMBARIO_TUTOR1]           MSG_EnemyName_Goombario,
    [ACTOR_TYPE_MAGIKOOPA_BOSS]             MSG_EnemyName_MagikoopaBoss,
    [ACTOR_TYPE_FLYING_MAGIKOOPA_BOSS]      MSG_EnemyName_MagikoopaBossDup,
    [ACTOR_TYPE_MAGIKOOPA_DUP1]             MSG_EnemyName_MagikoopaBoss,
    [ACTOR_TYPE_MAGIKOOPA_DUP2]             MSG_EnemyName_MagikoopaBossDup,
    ...
    [ACTOR_TYPE_ELDSTAR]                    MSG_EnemyName_Goombario,
    ...
    [ACTOR_TYPE_TUBBA_BLUBBA]               MSG_EnemyName_TubbaBlubbaInvincible,
    ...
    [ACTOR_TYPE_LAVA_PIRANHA_PHASE_1]       MSG_EnemyName_LavaPiranhaPhase1,
    [ACTOR_TYPE_LAVA_PIRANHA_PHASE_2]       MSG_EnemyName_LavaPiranhaPhase2,
    [ACTOR_TYPE_LAVA_BUD_PHASE_1]           MSG_EnemyName_LavaBudPhase1,
    [ACTOR_TYPE_LAVA_BUD_PHASE_2]           MSG_EnemyName_LavaBudPhase2,
    [ACTOR_TYPE_PETIT_PIRANHA]              MSG_EnemyName_PetitPiranha,
    [ACTOR_TYPE_PETIT_PIRANHA_BOMB]         MSG_EnemyName_LavaPiranhaPhase1,
    ...
    [ACTOR_TYPE_CRYSTAL_CLONE]              MSG_EnemyName_CrystalClone,
    [ACTOR_TYPE_CRYSTAL_BIT]                MSG_EnemyName_CrystalBit,
    [ACTOR_TYPE_INTRO_BOWSER]               MSG_EnemyName_IntroBowser,
    [ACTOR_TYPE_HALLWAY_BOWSER]             MSG_EnemyName_HallwayBowser,
    [ACTOR_TYPE_HALLWAY_BOWSER_DUP]         MSG_EnemyName_HallwayBowser,
    [ACTOR_TYPE_FINAL_BOWSER_1]             MSG_EnemyName_FinalBowser,
    [ACTOR_TYPE_FINAL_BOWSER_1_DUP]         MSG_EnemyName_FinalBowser,
    [ACTOR_TYPE_FINAL_BOWSER_2]             MSG_EnemyName_FinalBowser2,
    [ACTOR_TYPE_FINAL_BOWSER_2_DUP]         MSG_EnemyName_FinalBowser2,
...
s32 bActorTattles[] = {
    [ACTOR_TYPE_RED_GOOMBA]                 MSG_EnemyTattle_RedGoomba,
    [ACTOR_TYPE_RED_PARAGOOMBA]             MSG_EnemyTattle_RedParagoomba,
    ...
    [ACTOR_TYPE_FUZZIPEDE]                  MSG_EnemyTattle_Fuzzipede,
    [ACTOR_TYPE_HURT_PLANT]                 MSG_EnemyTattle_HurtPlant,
    [ACTOR_TYPE_M_BUSH]                     MSG_EnemyTattle_MBush,
    [ACTOR_TYPE_AQUA_FUZZY]                 MSG_EnemyTattle_AquaFuzzy,
    ...
    [ACTOR_TYPE_TWINK]                      MSG_EnemyTattle_Twink,
    ...
    [ACTOR_TYPE_KAMMY_KOOPA]                MSG_EnemyTattle_KammyKoopa,
    [ACTOR_TYPE_JR_TROOPA_1]                MSG_EnemyTattle_JrTroopaUnused,
    ...
    [ACTOR_TYPE_GOOMBARIO_TUTOR1]           MSG_EnemyTattle_Goombario,
    ...
    [ACTOR_TYPE_ELDSTAR]                    MSG_EnemyTattle_Goombario,
    ...
    [ACTOR_TYPE_GENERAL_GUY]                MSG_EnemyTattle_GeneralGuyDup,
    [ACTOR_TYPE_TOY_TANK]                   MSG_EnemyTattle_GeneralGuy,
    [ACTOR_TYPE_LIGHT_BULB]                 MSG_EnemyTattle_LightBulb,
    [ACTOR_TYPE_SIGNAL_GUY]                 MSG_EnemyTattle_ShyGuy,
    [ACTOR_TYPE_SHY_SQUAD_REDUX]            MSG_EnemyTattle_ShySquadRedux,
    ...
    [ACTOR_TYPE_INTRO_BOWSER]               MSG_EnemyTattle_IntroBowser,
